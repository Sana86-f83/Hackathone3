...
const Footer = () => {
  return (
    <div className="w-[1920px] h-[740.15px] bg-black">
      <div className="h-[740.15px] w-[1920px] mt-[120px] text-white bg-black">
        {/* // main Footer Div */}
        <div className="h-[640.15px] w-[1320px]  ml-[300px] mt-[120px] pt-[48px] flex relative text-white ">
        ...
        <div className="h-[100px] w-[1920px] flex    bg-darkyellow">
          <p className="h-[24px] mt-[38px] ml-[300px] ">
            Copyright © 2022 by Ayeman. All Rights Reserved.
          </p>

          <div className="h-[34px]  w-[240px] flex justify-between items-center mt-[33px] ml-[721px] ">
